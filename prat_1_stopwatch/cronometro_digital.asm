...
AGUARDA_SW0:
    JB      SW0, AGUARDA_SW1   ; Verifica se o botão SW0 está pressionado, se sim, salta para AGUARDA_SW1
    MOV     7FH, #5            ; Se SW0 não estiver pressionado, carrega o valor 5
    JMP     INTER_SW0          ; Salta para a sub-rotina INTER_SW0

AGUARDA_SW1:
    JB      SW1, AGUARDA_SW0   ; Verifica se o botão SW1 está pressionado, se sim, salta para AGUARDA_SW0
    MOV     7FH, #20           ; Se SW1 não estiver pressionado, carrega o valor 20
...
INTER_SW0:
    ...
    SJMP    AGUARDA_SW0        ; Salta para AGUARDA_SW0 para aguardar o próximo pressionamento de SW0
...
INTER_SW1:
    ...
    MOV     R1, #0             ; Se R1 for igual a 10, reinicia R1
    SJMP    AGUARDA_SW1        ; Salta para AGUARDA_SW1 para aguardar o próximo pressionamento de SW1
